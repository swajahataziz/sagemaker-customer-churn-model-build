...
def get_pipeline(
    ...
    input_data = ParameterString(
        name="InputDataUrl",
        default_value=f"s3://sagemaker-us-east-1-463045133778/sagemaker/DEMO-xgboost-churn/data/RawData.csv",  # Change this to point to the s3 location of your raw input data.
    )
    output_dir = ParameterString(
        name="OutputDataUrl",
        default_value=f"s3://sagemaker-us-east-1-463045133778/sagemaker/DEMO-xgboost-churn/output"+ts,  # Change this to point to the s3 location of your raw input data.
    )
    ...
    step_process = ProcessingStep(
        ...
        job_arguments=["--input-data", input_data, "--output-dir", output_dir],
    )
